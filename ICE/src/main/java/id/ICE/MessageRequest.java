...
public class MessageRequest {
     ...
     * All requests sent by the client in same connection will have same connection id.
     */
     ...
     * If service requested to ignore next client request (see {@link MessageResponse#withIgnoreNextRequest})
